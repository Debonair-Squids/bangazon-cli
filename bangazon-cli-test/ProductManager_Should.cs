...
namespace bangazon_cli_test
{
  public class ProductManager_Should
  {
    ...
    {
      ProductManagerShould();
      Customer activeCustomer = new Customer(2, "Kolden", "Prue", "Street Adress", "Nashville", "TN","376787", "763726327868");
    ...
    {
      ProductManagerShould();
      Customer activeCustomer = new Customer(1, "Kolden", "Prue", "Street Adress", "Nashville", "TN","376787", "763726327868");
